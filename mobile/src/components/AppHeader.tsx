 ...
 * challenge invites (the closest thing this app has to a notification
 * center today) and jumps to the home screen's invites section.
 */
export function AppHeader() {
  ...
  const pendingCount = challenges.filter((c) => c.status === 'pending' && c.my_status === 'invited').length;
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        accessibilityLabel={pendingCount > 0 ? `Bildirimler, ${pendingCount} yeni davet` : 'Bildirimler'}
        accessibilityRole="button"
      >
